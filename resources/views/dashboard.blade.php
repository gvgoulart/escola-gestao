...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class=" brand-image img-circle elevation-3 animation__shake" src="escola/dist/img/png-clipart-php-php.png" style="opacity: .8" alt="AdminLTELogo" height="60" width="60">
  </div>
